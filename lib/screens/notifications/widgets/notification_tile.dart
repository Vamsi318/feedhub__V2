...
import 'package:feedhub/widgets/user_profile_image.dart';
  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: UserProfileImage(
          radius: 18.0, profileImageUrl: notification.fromUser.profileImageUrl),
      title: Text.rich(
        TextSpan(
          children: [
            TextSpan(
  ...
  Widget _getTrailing(BuildContext context, Notif notif) {
    if (notification.type == NotifType.like ||
      ...
      return GestureDetector(
        onTap: () => Navigator.of(context).pushNamed(CommentsScreen.routeName,
